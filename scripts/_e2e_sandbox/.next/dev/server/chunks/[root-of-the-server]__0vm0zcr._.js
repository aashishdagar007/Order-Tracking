...
async function GET() {
    try {
        const session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getSessionUser"])();
        ...
        const where = session.adminId ? {
            adminId: session.userId
        } : {
            role: 'WORKER'
        };
        const workers = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.findMany({
            where,
            select: {
                id: true,
                username: true,
...
async function POST(request) {
    try {
        ...
        const { username, name, password, canViewOrders = true, canPickPack = true, canDispatch = false, canUpload = false, canExport = false, canViewLogs = false } = await request.json();
        ...
        const newWorker = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.create({
            data: {
                username: cleanUsername,
                name: name.trim(),
                passwordHash,
...
async function PUT(request) {
    try {
        ...
        const { id, name, password, canViewOrders, canPickPack, canDispatch, canUpload, canExport, canViewLogs, isActive } = await request.json();
        if (!id) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        if (password) updateData.passwordHash = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hashPassword"])(password);
        ...
        const updatedWorker = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.update({
            where: {
                id
            },
            data: updateData,
...
async function DELETE(request) {
    try {
        ...
        const deleted = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.delete({
            where: {
                id
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0vm0zcr._.js.map