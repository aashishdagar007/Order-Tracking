...
"[project]/app/api/analytics/kpis/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        const session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getSessionUser"])(request);
        if (!session) {
        ...
        // 1. Fetch Orders (select only needed fields for KPI calculation)
        const allOrders = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].order.findMany({
            select: {
                status: true,
                priority: true,
                enteredAt: true,
        ...
        const todayEvents = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].orderEvent.findMany({
            where: {
                timestamp: {
                    gte: startOfToday
                }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1eqobwc._.js.map