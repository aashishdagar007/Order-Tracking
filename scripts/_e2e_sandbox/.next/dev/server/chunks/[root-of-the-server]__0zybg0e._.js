...
async function GET(request) {
    const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getSessionUser"])();
    ...
    if (user.role !== 'ADMIN' && user.permissions?.canViewLogs !== true) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Forbidden: Log view permission required'
        }, {
            status: 403
        });
    }
    try {
        ...
        const logs = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].log.findMany({
            where,
            orderBy: {
                timestamp: 'desc'
            },
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0zybg0e._.js.map