...
"[project]/app/api/activity/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const workerActivities = await Promise.all(workers.map(async (worker)=>{
            ...
            const [todayEventsCount, recentEvents] = await Promise.all([
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].orderEvent.count({
                    where: {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].orderEvent.findMany({
                    where: {
                        actorName: worker.name
                    },
                    take: 5,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0wi84_d._.js.map