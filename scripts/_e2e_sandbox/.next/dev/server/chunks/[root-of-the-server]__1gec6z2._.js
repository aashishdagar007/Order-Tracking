...
async function POST(request) {
    try {
        ...
        let user = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.findFirst({
            where: {
                OR: [
                    {
        ...
        // If no user exists and database is fresh, create default admin, worker, or client
        if (!user && (role === 'ADMIN' || loginIdentifier.toLowerCase() === 'admin')) {
            user = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.create({
                data: {
                    username: 'admin',
                    name: 'Master Admin',
                    passwordHash: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hashPassword"])('admin123'),
                    role: 'ADMIN',
                    canViewOrders: true,
                    canPickPack: true,
                    canDispatch: true,
        ...
        } else if (!user && loginIdentifier.toLowerCase() === 'worker') {
            user = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.create({
                data: {
                    username: 'worker',
                    name: 'Warehouse Operator',
                    passwordHash: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hashPassword"])('worker123'),
                    role: 'WORKER',
                    canViewOrders: true,
                    canPickPack: true,
                    canDispatch: true,
        ...
        } else if (!user && loginIdentifier.toLowerCase() === 'client') {
            user = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.create({
                data: {
                    username: 'client',
                    name: 'Partner Client',
                    passwordHash: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hashPassword"])('client123'),
                    role: 'CLIENT',
                    canViewOrders: true,
                    canPickPack: false,
                    canDispatch: false,
        ...
        if (!user) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Account not found. Please contact your warehouse admin.'
            }, {
                status: 401
            });
        }
        if (!user.isActive) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Your account is deactivated. Please contact your admin.'
            }, {
                status: 403
            });
        }
        const isPasswordValid = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifyPassword"])(password, user.passwordHash);
        if (!isPasswordValid) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const token = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSessionToken"])(user);
...
async function GET(request) {
    try {
        ...
        const dbUser = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.findUnique({
            where: {
                id: user.userId
            },
            select: {
...
async function PATCH(request) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateWorkerHeartbeat"])(user.userId, actionText);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true
        });
    } catch  {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1gec6z2._.js.map