...
async function GET(request) {
    ...
    try {
        const configs = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].config.findMany();
        const configMap = {};
        configs.forEach((c)=>{
...
async function PUT(request) {
    const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getSessionUser"])(request);
    if (!user || user.role !== 'ADMIN') return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: 'Unauthorized'
    }, {
        status: 401
    });
    try {
        ...
        if (workerPassword && String(workerPassword).trim()) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].config.upsert({
                where: {
                    key: 'workerPassword'
                },
                update: {
                    value: String(workerPassword).trim()
                },
                create: {
                    key: 'workerPassword',
                    value: String(workerPassword).trim()
        ...
        if (adminPassword && String(adminPassword).trim()) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].config.upsert({
                ...
                update: {
                    value: String(adminPassword).trim()
                },
                create: {
                    key: 'adminPassword',
                    value: String(adminPassword).trim()
...
//# sourceMappingURL=%5Broot-of-the-server%5D__038pj3p._.js.map